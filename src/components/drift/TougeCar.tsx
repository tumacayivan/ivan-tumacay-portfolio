 ...
 * follow the road.
 */
const TougeCar = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 64 32" className={`overflow-visible ${className}`} aria-hidden>
    <defs>
      ...
      <radialGradient id="car-tail" cx="0.5" cy="0.5" r="0.5">
      ...
      <linearGradient id="car-body" x1="0" y1="0" x2="0" y2="1">
        ...
        <stop offset="50%" stopColor="hsl(220 10% 90%)" />
    ...
    <g style={{ mixBlendMode: "screen" }} className="animate-pulse [animation-duration:3s]">
      <polygon points="58,6 140,-14 140,14" fill="url(#car-beam)" />
      <polygon points="58,26 140,18 140,46" fill="url(#car-beam)" />
    </g>

    {/* Tail-light glow */}
    <ellipse cx="3" cy="8" rx="9" ry="6" fill="url(#car-tail)" />
    <ellipse cx="3" cy="24" rx="9" ry="6" fill="url(#car-tail)" />
    ...
    {/* Body */}
    <rect x="3" y="3" width="58" height="26" rx="7" fill="url(#car-body)" stroke="hsl(var(--card-ink))" strokeWidth="0.8" />

    {/* Black bonnet and hatch (panda two-tone) */}
    <path d="M 44 4 L 54 4 Q 61 4 61 10 L 61 22 Q 61 28 54 28 L 44 28 Q 46 16 44 4 Z" fill="hsl(246 30% 8%)" />
    <path d="M 3 10 Q 3 4 9 4 L 12 4 Q 10 16 12 28 L 9 28 Q 3 28 3 22 Z" fill="hsl(246 30% 8%)" />

    {/* Bonnet vent line */}
    <path d="M 50 11 L 55 11 M 50 21 L 55 21" stroke="hsl(0 0% 30%)" strokeWidth="0.8" />

    {/* Windscreen, roof, rear glass */}
    <path d="M 33 6.5 L 41 5.5 Q 44 16 41 26.5 L 33 25.5 Q 35 16 33 6.5 Z" fill="url(#car-glass)" />
    <rect x="20" y="7" width="13" height="18" rx="2" fill="hsl(0 0% 97%)" stroke="hsl(220 10% 80%)" strokeWidth="0.5" />
    <path d="M 20 7.5 L 14 8.5 Q 12.5 16 14 23.5 L 20 24.5 Q 18.5 16 20 7.5 Z" fill="url(#car-glass)" />
    {/* Roof highlight */}
    <rect x="22" y="9" width="8" height="2" rx="1" fill="white" opacity="0.9" />

    {/* Side mirrors */}
    <rect x="38" y="1.2" width="3" height="2.4" rx="0.8" fill="hsl(246 30% 8%)" />
    <rect x="38" y="28.4" width="3" height="2.4" rx="0.8" fill="hsl(246 30% 8%)" />
    ...
    {/* Rear spoiler */}
    <rect x="6" y="3.5" width="2.2" height="25" rx="1" fill="hsl(246 30% 5%)" />

    {/* Orange livery stripe */}
    <path d="M 13 15 L 44 15 L 44 17 L 13 17 Z" fill="hsl(var(--neon-drift))" opacity="0.9" />
  </svg>
);
