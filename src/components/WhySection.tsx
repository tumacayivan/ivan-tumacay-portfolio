  ...
  return (
    <section className="relative py-20 sm:py-28 overflow-hidden bg-[hsl(var(--paper))] border-t border-[hsl(var(--accent-red)/0.25)]">
      ...
      <div className="absolute inset-x-0 top-0 h-[400px] pointer-events-none"
           style={{ background: "radial-gradient(ellipse at 50% 0%, hsl(43 70% 32% / 0.2) 0%, transparent 60%)" }} />
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-20 relative">
        <div className="paper-card-cream p-6 sm:p-10 md:p-14 relative paper-grain overflow-hidden">
          ...
          >
            ...
            <div className="border-y border-[hsl(var(--accent-red)/0.5)] py-5 my-6 max-w-4xl relative bg-[hsl(45_36%_97%/0.4)] backdrop-blur-sm px-5">
              ...
              <p className="font-typewriter text-lg sm:text-xl md:text-2xl text-[hsl(var(--ink-charcoal))] leading-relaxed">
                <span className="font-blackops text-[hsl(var(--accent-red))] text-sm tracking-[0.3em]">VERDICT //</span>{" "}
            ...
            <div className="font-blackops text-sm sm:text-base tracking-[0.3em] text-[hsl(var(--accent-red))] mb-3 uppercase">
              ▣ The Closer's Core Competencies
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {reasons.map(({ icon: Icon, label }, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 px-4 py-3 bg-[hsl(45_36%_97%)] border border-[hsl(var(--accent-red)/0.45)] relative hover:border-[hsl(var(--accent-red))] hover:bg-[hsl(45_28%_94%)] transition-colors group"
                >
                  <span className="absolute -top-2 -left-2 w-4 h-4 bg-[hsl(45_36%_97%)] border border-[hsl(var(--accent-red))] flex items-center justify-center font-courier text-[10px] text-[hsl(var(--accent-red))]">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-[hsl(var(--accent-red)/0.4)] pt-4">
              <div className="font-courier text-[11px] tracking-[0.3em] text-[hsl(var(--ink-brown))] uppercase">
                <div className="text-[hsl(var(--ink-brown))]">RATED BY</div>
                <div className="text-[hsl(var(--accent-red))] font-bold mt-1">RESEARCH DESK / IVT</div>
              </div>
              <div className="font-courier text-[11px] tracking-[0.3em] text-[hsl(var(--ink-brown))] uppercase">
              ...
              <div className="font-courier text-[11px] tracking-[0.3em] text-[hsl(var(--ink-brown))] flex items-end justify-end gap-2 uppercase">
                ...
                <span className="text-[hsl(var(--accent-red))]">RATING: STRONG BUY</span>
              </div>
            </div>
          </motion.div>
        </div>
